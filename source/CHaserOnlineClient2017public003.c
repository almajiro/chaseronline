/****************************************************/
/*													*/
/*	CHaserOnlineClient2017public003					*/
/*													*/
/*	Date	2017.7.19								*/
/*													*/
/****************************************************/
	...
	while(1){
		...
		do{
			...
			if(ActionCount == 9){
				if(mode==51){
					...
					else if(ActionReturnNumber[3]==1){
						GetReadyMode = 3;
					}
					else if(ActionReturnNumber[3]==2){
						GetReadyMode = 1;
					}
				}
			}
		...
		do{
			...
			if(count == 9){
				...
				else if(returnNumber[3]==3){
					mode = 57;
				}
				else if(returnNumber[1]==2){
					mode = 51;
				}
				else if(returnNumber[1]==1){
					mode = 53;
				}
				else if(returnNumber[0]==7){
					mode = 53;
				}
				else{
					mode = 55;
